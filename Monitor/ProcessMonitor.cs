...
namespace Monitor
{
    class ProcessMonitor
    {
        ...
        public void AssignBottumWindow(IntPtr mainWindowHandle)
        {
            SetWindowPos(mainWindowHandle, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOACTIVATE);
        }
        ...
        public static void ClickToFocus(IntPtr mainWindowHandle)
        {
            RECT rect = new RECT();
            GetWindowRect(mainWindowHandle, out rect);
            Point p = new Point(rect.Left + rect.Width / 2,
